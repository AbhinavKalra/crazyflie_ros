...
public:
...

    {
        ...
        m_pubGoalPosition = nh.advertise<crazyflie_driver::Position>("cmd_position",1);
        ...
        case Automatic:
            {
                ...
                crazyflie_driver::Position goal_position_msg;
                ...
                goal_position_msg.x=m_goal.pose.position.x;
                goal_position_msg.y=m_goal.pose.position.y;
                goal_position_msg.z=m_goal.pose.position.z;
                goal_position_msg.yaw=0;              //// JUGAAD Look here for problems
                m_pubGoalPosition.publish(goal_position_msg);
            }
            break;
        case Idle:
            {
...
private:
    ...
    ros::Publisher m_pubGoalPosition;
...
{
  ros::init(argc, argv, "newController");
